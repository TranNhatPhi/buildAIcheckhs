...
LOW_SKILL_ITEMS = [
    ...
    dict(id="resume-cv", order=19, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Resume/ CV"),
    dict(id="thu-xac-nhan-kinh-nghiem", order=20, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Thư xác nhận kinh nghiệm làm việc"),
    dict(id="thu-tai-tuyen-dung", order=21, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Thư xác nhận tái tuyển dụng"),
    dict(id="thu-xac-nhan-ubnd", order=22, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Thư xác nhận của UBND (nếu có)", isOptional=True),
    dict(id="hop-dong-lao-dong", order=23, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Hợp đồng lao động"),
    dict(id="sao-ke-ngan-hang-phieu-luong", order=24, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Phiếu lương / sao kê lương"),

    # --- IV. Giấy tờ chứng minh tài chính ---
    dict(id="so-tiet-kiem", order=25, section=SECTION_APPLICANT, group=GROUP_FINANCE,
         nameVi="Sổ tiết kiệm", note="Yêu cầu làm bản song ngữ Anh - Việt."),
    dict(id="xac-nhan-so-du-tiet-kiem", order=26, section=SECTION_APPLICANT, group=GROUP_FINANCE,
    ...
    dict(id="giay-to-nha-dat", order=27, section=SECTION_APPLICANT, group=GROUP_FINANCE,
    ...
    dict(id="cccd-vo-chong", order=28, section=SECTION_DEPENDENTS, group=GROUP_DEPENDENT_PERSONAL,
         nameVi="Căn cước công dân vợ/chồng", appliesTo="SPOUSE"),
    dict(id="giay-khai-sinh-vo-chong", order=29, section=SECTION_DEPENDENTS, group=GROUP_DEPENDENT_PERSONAL,
         nameVi="Giấy khai sinh vợ/chồng", appliesTo="SPOUSE"),
    dict(id="giay-khai-sinh-con1", order=30, section=SECTION_DEPENDENTS, group=GROUP_DEPENDENT_PERSONAL,
         nameVi="Giấy khai sinh - con 1 (nếu có)", isOptional=True, appliesTo="CHILD_1"),
    dict(id="giay-khai-sinh-con2", order=31, section=SECTION_DEPENDENTS, group=GROUP_DEPENDENT_PERSONAL,
    ...
    dict(id="giay-khai-sinh-con3", order=32, section=SECTION_DEPENDENTS, group=GROUP_DEPENDENT_PERSONAL,
    ...
    dict(id="cccd-cha-vo-chong", order=33, section=SECTION_DEPENDENTS, group=GROUP_OTHER,
         nameVi="Căn cước công dân bố (nếu có)", isOptional=True),
    dict(id="cccd-me-vo-chong", order=34, section=SECTION_DEPENDENTS, group=GROUP_OTHER,
         nameVi="Căn cước công dân mẹ (nếu có)", isOptional=True),
    dict(id="thu-ho-tro-bo-me", order=35, section=SECTION_DEPENDENTS, group=GROUP_OTHER,
...
HIGH_SKILL_APPLICANT_ITEMS = [
    ...
    # --- III. Giấy tờ chứng minh kinh nghiệm làm việc ---
    dict(id="hs-resume-cv", order=21, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Resume/ CV"),
    dict(id="hs-thu-xac-nhan-kinh-nghiem", order=22, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Thư xác nhận kinh nghiệm làm việc"),
    dict(id="hs-thu-tai-tuyen-dung", order=23, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Thư xác nhận tái tuyển dụng"),
    dict(id="hs-thu-xac-nhan-ubnd", order=24, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Thư xác nhận của UBND (nếu có)", isOptional=True),
    dict(id="hs-hop-dong-lao-dong", order=25, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Hợp đồng lao động"),
    dict(id="hs-phieu-luong", order=26, section=SECTION_APPLICANT, group=GROUP_WORK,
         nameVi="Phiếu lương / sao kê lương"),

    # --- IV. Giấy tờ chứng minh tài chính ---
    dict(id="hs-so-tiet-kiem", order=27, section=SECTION_APPLICANT, group=GROUP_FINANCE,
         nameVi="Sổ tiết kiệm", note="Yêu cầu làm bản song ngữ Anh - Việt."),
    dict(id="hs-xac-nhan-so-du-tiet-kiem", order=28, section=SECTION_APPLICANT, group=GROUP_FINANCE,
         nameVi="Giấy xác nhận số dư sổ tiết kiệm",
         note="Yêu cầu làm bản song ngữ Anh - Việt. Độc thân: tối thiểu 100-150 triệu. "
              "Đã kết hôn: tối thiểu 200-300 triệu. Kết hôn có 1 con: 350 triệu. "
              "Kết hôn 2 con: 400 triệu. Thêm 1 người thì tăng thêm 50 triệu.",
         verificationNote="Tuỳ theo khách mà bỏ số dư cho hợp lý."),
    dict(id="hs-quyen-su-dung-dat", order=29, section=SECTION_APPLICANT, group=GROUP_FINANCE,
         nameVi="Quyền sử dụng đất",
         note="Sao y công chứng tại văn phòng công chứng hoặc cơ quan nhà nước, không quá 1 tháng. "
              "Nếu không đứng tên trên sổ hồng/sổ đỏ thì lấy giấy tờ đất của bố mẹ ruột. "
              "Nếu đang thế chấp ngân hàng thì nhờ ngân hàng photo công chứng 1 bản."),
...
HIGH_SKILL_SPOUSE_ITEMS = [
    dict(id="hs-spouse-passport", order=30, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Passport"),
    dict(id="hs-spouse-cccd", order=31, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Căn cước công dân"),
    dict(id="hs-spouse-cmnd", order=32, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Chứng minh nhân dân (Nếu có)", isOptional=True),
    dict(id="hs-spouse-khai-sinh", order=33, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Giấy khai sinh"),
    dict(id="hs-spouse-hinh-the-trang", order=34, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Hình thẻ trắng",
         note="Kích thước: 3.5cm x 4.5cm. Chỉ cần gửi file hình, không cần rửa ra ảnh."),
    dict(id="hs-spouse-ly-hon", order=35, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Giấy quyết định ly hôn (Nếu có)", isOptional=True,
         note="Trường hợp vợ/chồng đã từng ly hôn thì bổ sung"),
    dict(id="hs-spouse-lltp2", order=36, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Lý lịch tư pháp số 2",
         verificationNote="Hạn trong vòng 1 năm, phải có chữ ký điện tử và tên của cán bộ làm "
                           "giấy, phải khớp thông tin như CCCD, ngày cấp..."),
    dict(id="hs-spouse-lltp-nuoc-ngoai", order=37, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Lý lịch tư pháp tại nước ngoài (nếu có)", isOptional=True),
    dict(id="hs-spouse-kham-suc-khoe", order=38, section=SECTION_SPOUSE, group=GROUP_PERSONAL,
         nameVi="Giấy khám sức khoẻ tại nơi chỉ định (nếu có)", isOptional=True,
         note="Tổ chức di cư quốc tế IOM"),

    dict(id="hs-spouse-bang-cao-nhat", order=39, section=SECTION_SPOUSE, group=GROUP_DEGREE,
         nameVi="Bằng cấp cao nhất"),
    dict(id="hs-spouse-hocba-bangdiem-cao-nhat", order=40, section=SECTION_SPOUSE, group=GROUP_DEGREE,
         nameVi="Học bạ/ bảng điểm cao nhất"),
    dict(id="hs-spouse-chung-chi-nghe-khac", order=41, section=SECTION_SPOUSE, group=GROUP_DEGREE,
         nameVi="Các bằng cấp/chứng chỉ nghề khác (Nếu có)", isOptional=True),
    dict(id="hs-spouse-chung-chi-tieng-anh", order=42, section=SECTION_SPOUSE, group=GROUP_DEGREE,
         nameVi="Chứng chỉ thi tiếng Anh (Nếu có)", isOptional=True),

    dict(id="hs-spouse-thu-xac-nhan-kinh-nghiem", order=43, section=SECTION_SPOUSE,
         group=GROUP_WORK_FINANCE, nameVi="Thư xác nhận kinh nghiệm làm việc"),
    dict(id="hs-spouse-hop-dong-lao-dong", order=44, section=SECTION_SPOUSE,
         group=GROUP_WORK_FINANCE, nameVi="Hợp đồng lao động"),
    dict(id="hs-spouse-phieu-luong", order=45, section=SECTION_SPOUSE,
         group=GROUP_WORK_FINANCE, nameVi="Phiếu lương / sao kê lương"),
    dict(id="hs-spouse-so-tiet-kiem", order=46, section=SECTION_SPOUSE,
         group=GROUP_WORK_FINANCE, nameVi="Sổ tiết kiệm (nếu có)", isOptional=True,
         note="Yêu cầu làm bản song ngữ Anh - Việt."),
    dict(id="hs-spouse-xac-nhan-so-du", order=47, section=SECTION_SPOUSE,
    ...
    dict(id="hs-spouse-quyen-su-dung-dat", order=48, section=SECTION_SPOUSE,
...
HIGH_SKILL_CHILDREN_ITEMS = (
    _high_skill_child_items(1, 49) + _high_skill_child_items(2, 57) + _high_skill_child_items(3, 65)
)
